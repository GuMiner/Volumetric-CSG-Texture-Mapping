	...
	while (1)
	  {
        ...
        if (mparam.enableOutput)
		    cout << "define solid " << solidname << endl;
	      }
		  ...
		  case TOK_FACE:
		    {
		      ...
		      cout << "Singular Face  with factor " << factor << std::endl;
		  ...
		  case TOK_EDGE:
		    {
		      ...
		      cout << "Singular Edge  with factor " << factor << std::endl;
		  ...
		  case TOK_POINT:
		    {
		      ...
		      cout << "Singular Point  with factor " << factor << std::endl;
        ...
        if (mparam.enableOutput)
		    cout << "define 2d curve " << curvename << endl;
	      }
		...
		geom->SetSplineCurve(curvename.c_str(),newspline);
        if (mparam.enableOutput)
		    cout << "define 3d curve " << curvename << std::endl;
	      }
