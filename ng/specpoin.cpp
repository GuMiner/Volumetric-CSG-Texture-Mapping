...
namespace netgen
{
        ...
        Array<MeshPoint> & apoints)
    {
        ...
        if (mparam.enableOutput)
            cout << endl << "Find Special Points" << endl;
        ...
        box.CalcDiamCenter();
        if (mparam.enableOutput)
            cout << "TLO Count: " << geometry->GetNTopLevelObjects() << endl;
        ...
        if (mparam.enableOutput)
        {
            ...
            cout << "Points Found Per Surface: " << endl;
            for (int i = 1; i < numprim_hist.Size(); i++)
            {
                cout << " " << i << ": " << numprim_hist[i] << endl;
            }
        }
    }
        ...
        int level, bool calccp, bool calcep)
    {
        ...
        if (level >= 100)
        {
            ...
            sstream << "Problems in CSP, point: " << box.Center() << ".";
            throw NgException (sstream.str().c_str());
        }
        ...
        int dir, Point<3> & p)
    {
        ...
        if (Abs2 (x) > 1e-20)
        {
            cout << "Error: extremum Newton not convergent" << endl;
            cout << "dir = " << dir << endl;
            cout << "p = " << p << endl;
            cout << "x = " << x << endl;
        }
